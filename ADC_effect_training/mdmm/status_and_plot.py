...
CASES = {
    ...
    "2ns5ns": {
        "trained_models_dir": os.path.join(DATASET_BASE, "trained_models_2_5_noise_corr_contained_mdmm"),
...
PART1P5_2P5_CASES = {
    "2ns5ns": {
        ...
        "part1p5_output_dir": os.path.join(
            DATASET_BASE, "trained_models_2_5_noise_corr_contained_mdmm", "part1p5_vit"),
        "part2p5_output_dir": os.path.join(
            DATASET_BASE, "trained_models_2_5_noise_corr_contained_mdmm", "part2p5_qconv2d"),
