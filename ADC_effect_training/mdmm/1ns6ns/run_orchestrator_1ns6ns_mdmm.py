"""
Orchestrator for the 1ns/6ns MDMM threshold search.
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("train_loop_rnd_thr_noise_corr_contained_1ns6ns_mdmm.out"),
...
TRAINED_MODELS_DIR = (
    ...
    "shuffled_3d/trained_models_1_6_noise_corr_contained_mdmm"
)
JSONL_PATH = os.path.join(
    TRAINED_MODELS_DIR,
    "threshold_runs_rnd_thr_noise_corr_contained_mdmm.jsonl",
)
MEDIAN_PATH = os.path.join(
    TRAINED_MODELS_DIR,
    "median_thresholds_rnd_thr_noise_corr_contained_mdmm.json",
)
TRAINING_SCRIPT = os.path.join(
    os.path.dirname(os.path.abspath(__file__)),
    "train_loop_rnd_thr_noise_corr_contained_1ns6ns_mdmm.py",
)
...
def write_median():
    ...
    summary = {
        ...
        "note": "median over non-stuck runs; per-run details in threshold_runs_rnd_thr_noise_corr_contained_mdmm.jsonl",
    }
