...
ax.set_title(f"MDMM + corr noise + contained + 1ns/6ns + 5000ep: threshold convergence\n"
...
plt.tight_layout()
out = os.path.join(os.path.dirname(os.path.abspath(__file__)), "run_thresholds_1ns6ns_mdmm.png")
