"""
Evaluate a Part 1.5 no-noise (2ns5ns) ViT run: residuals, pulls, sigma hists,
and summary (money) plots. Identical to plotting/part1p5/eval_part1p5_2ns5ns.py
except it points at the no-noise output dir/TFR files
(trained_models_2_5_noise_corr_contained_mdmm/part1p5_no_noise,
TFR_files_2_5_no_noise_contained) -- see
train_vit_part1p5_no_noise_2ns5ns_mdmm_corr1e4.py for the training script this
evaluates.
"""
import os
import sys
...
# repo root: file lives in ADC_effect_training/plotting/part1p5_no_noise/, 3 levels down
...
CASE_TAG = "Part 1.5 no-noise (ViT, frozen hard-digitized thresholds, MDMM) 2ns/5ns"
...
if not summary_paths:
    raise SystemExit(f"No Part 1.5 no-noise summary.json found under {part1p5_output_dir} -- has a run completed yet?")
