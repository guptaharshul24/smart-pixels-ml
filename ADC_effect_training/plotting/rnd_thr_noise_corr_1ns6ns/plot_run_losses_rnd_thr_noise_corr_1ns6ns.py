...
axes[0].set_title("Training loss (correlated noise, 5000ep target)")
axes[1].set_title("Validation loss (correlated noise, 5000ep target)")
for ax in axes:
    ax.set_xlabel("epoch")
    ax.set_ylabel("loss")
    ax.legend()
...
plt.tight_layout()
out = "/home/harshul-cern/harshul/smart-pixels-ml/ADC_effect_training/plotting/rnd_thr_noise_corr_1ns6ns/run_losses_rnd_thr_noise_corr_1ns6ns.png"
