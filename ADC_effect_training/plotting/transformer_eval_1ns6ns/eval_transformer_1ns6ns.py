...
corr-noise + contained + 1ns/6ns case: residuals, pulls, and summary (money) plots.
...
# repo root (two levels up from plotting/<case>/) for DG/models/utils imports
...
CASE_TAG = "corr noise + contained + 1ns/6ns"
...
records = [r for r in records if not r.get("stuck", False)]
if args.fingerprint:
