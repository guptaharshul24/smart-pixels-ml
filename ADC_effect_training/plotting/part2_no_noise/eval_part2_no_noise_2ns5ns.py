"""
Evaluate a Part 2 no-noise (2ns5ns) non-quantized Conv2D run: residuals,
pulls, sigma hists, and summary (money) plots. Same pattern as
plotting/part2/eval_part2_2ns5ns.py, points at part2_conv2d_no_noise/ and
TFR_files_2_5_no_noise_contained/TFR_val instead of the noisy counterparts.
"""
import os
import sys
import json
...
# repo root: file lives in ADC_effect_training/plotting/part2_no_noise/, 3 levels down
...
CASE_TAG = "Part 2 no-noise (non-quantized Conv2D, frozen hard-digitized thresholds, MDMM) 2ns/5ns"
...
if not summary_paths:
    raise SystemExit(f"No Part 2 no-noise summary.json found under {part2_output_dir} -- has a run completed yet?")
