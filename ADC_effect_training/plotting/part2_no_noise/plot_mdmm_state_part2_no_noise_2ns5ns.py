"""
MDMM constraint-penalty curves for Part 2 no-noise (2ns5ns) runs -- see
plotting/part2/plot_mdmm_state_part2_2ns5ns.py for the full explanation
...
if not any_mdmm:
    raise SystemExit("No MDMM runs found under Part 2 no-noise output dir yet (no pen_corr_* "
...
fig.suptitle("Part 2 no-noise (non-quantized Conv2D) 2ns/5ns: MDMM correlation-constraint penalties per parameter")
plt.tight_layout()
out_path = os.path.join(out, "mdmm_state_part2_no_noise_2ns5ns.png")
