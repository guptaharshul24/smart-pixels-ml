...
fig.suptitle(f"MDMM state (correlation constraints): pixelAV-matched (containment + |cotBeta|<2), {len(per_run)} run(s)")
plt.tight_layout()
out = os.path.join(os.path.dirname(os.path.abspath(__file__)), "mdmm_state_pixelav_matched_mdmm.png")
