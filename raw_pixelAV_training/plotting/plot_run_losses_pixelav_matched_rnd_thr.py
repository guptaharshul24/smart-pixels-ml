...
fig.suptitle("pixelAV-matched (containment + |cotBeta|<2, noise=[0,80]e-), Stage 1 ViT rnd_thr, 5000ep target")
plt.tight_layout()
out = os.path.join(here, "run_losses_pixelav_matched_rnd_thr.png")
